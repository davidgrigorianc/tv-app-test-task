import type { FeaturedVideoProps } from '../../types';

const FeaturedVideo: React.FC<FeaturedVideoProps> = ({ video, isPlaying, onPlayClick }) => {
    return (
            ...
            {isPlaying && video.VideoUrl ? (
                ...
                <>
                    ...
                    <div className="relative z-10 flex h-full flex-col justify-center px-6 py-10 text-white">
                        <div className="mb-2 text-[24px] leading-[42px] font-bold tracking-[4.8px] text-[#858688] uppercase">
                            {video.Category}
                        </div>
                        <img
                        ...
                        <div className="mt-6 flex gap-4">
                            ...
                            <button className="h-[72px] w-[240px] cursor-pointer rounded-[40px] bg-gradient-to-br from-[#2727F5] to-[#001671] text-center font-[Tajawal] text-[32px] leading-[30px] font-bold tracking-[-0.32px] text-[#F1F1F1]">
                                More Info
                            </button>
                        </div>
                    </div>
